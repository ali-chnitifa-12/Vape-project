    ...
    <div className="page-wrapper">
      ...
      <section className="about__hero">
        <div className="container">
          ...
          <h1 className="section-title">We Are <span className="gradient-text">VΛPΞ NΞON</span></h1>
          ...
          <div className="about__story-grid">
            ...
            <div className="about__story-content">
              ...
              <p className="about__text">
                VΛPΞ NΞON started in a small workshop with a simple mission: create vaping products that truly deliver on their promises. We were tired of overpriced, underperforming products flooding the market.
              </p>
              <p className="about__text">
      ...
      <section className="section">
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
            <span className="section-label" style={{ justifyContent: 'center' }}>The People Behind NΞON</span>
